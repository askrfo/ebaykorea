...
import examples.boot.simplechat.security.SimpleBoardTokenRepositoryImpl;
import examples.boot.simplechat.security.oauth2.AlreadyLoginCheckFilter;
...
public class WebApplicationSecurity  extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .logout().logoutRequestMatcher(new AntPathRequestMatcher("/logout")).logoutSuccessUrl("/chatrooms").and()
            .authorizeRequests()
